...
public class SegmentTreefortheMinimum {
	...
	static class SegTree {
		...
		public long comp(int l, int r, int x, int lx, int rx) {
			...
			int m = (lx + rx)/2;
			return Math.min(comp(l, r, 2*x+1, lx, m), comp(l, r, 2*x+2, m, rx));
		...
		public void set(int i, long v, int x, int lx, int rx) {
			...
			sums[x] = Math.min(sums[2*x+1], sums[2*x+2]);
		}
...
/*
	...
	keep track of the minimum within this subtree
